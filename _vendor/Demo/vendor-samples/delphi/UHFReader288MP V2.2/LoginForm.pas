...
uses
  ...
  Dialogs, StdCtrls,DevControl,UHFReader288MP_Head;
...
implementation
uses frmUHFReader288MPdemomain;
{$R *.dfm}
...
begin
  ...
  m:=frmUHFReader288MPmain.select_index;
  errorcode:=DM_AuthLogin(frmUHFReader288MPmain.m_hDevArray[m],usname,pass,1000);
